...
<body>
    ...
    <section class="main">
        ...
        <div class="view-users1">
            ...
            <center>
                <h1 style="color:white;background-color: rgba(0, 0, 0, 0.8); margin: top 50px;width:700px;height:100px;padding-top: 25px;">Connected Users for money transfer</h1>
            </center>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="./public/css/Money-Transfer-1.jpg" style="width: 600px;position: absolute;bottom: 0;" alt="">
                </div>
                        ...
                        <table class="center content-table ">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="selecteduser.php?id=<?php echo $rows['id']; ?>" class="btn btn-primary">Transact</a></td>
                                </tr>
                            <?php
                            }
                            ?>
