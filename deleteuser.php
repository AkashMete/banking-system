...
<body>
    <section class="main">
        ...
        <div class="view-users">
            ...
            <center>
                <h1 style="color:white;background-color: rgba(0, 0, 0, 0.8); margin: top 50px;width:700px;height:100px;padding-top: 25px;">Delete User Account</h1>
            </center>
            ...
            <center>
                <div class="message">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Enter details in order to verify existing user account.</h5>
            ...
            <center>
                <form action="deletesuccess.php" method="post">
                    <div class="mb-3">
                        <label for="acName" class="form-label">User Name</label>
                        <input type="text" style="width: auto;" class="form-control" name="name" id="name">
                    </div>
                    <div class="mb-3">
                        <label for="acEmail" class="form-label">Email address</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" style="width: auto;" class="form-control" name="balance" id="balance">
                    </div>
